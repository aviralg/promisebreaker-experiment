...
EXPERIMENT_VALIDATE_ANALYSIS_SCRIPT := $(PROJECT_DIRPATH)/analysis/validate.R
...
experiment-validate-summary:
	...
	docker run -i $(DOCKR_RUN_ARGS) dockr $(R_VANILLA_BIN) --file=$(EXPERIMENT_VALIDATE_ANALYSIS_SCRIPT) --args $(EXPERIMENT_VALIDATE_TRACE_PROGRAMS_DIRPATH) $(EXPERIMENT_VALIDATE_TRACE_PROGRAMS_JOBLOG_DIRPATH) $(EXPERIMENT_VALIDATE_SUMMARY_DIRPATH)
